...
// ====== Network Credentials ======
const char* ssid     = "ESP32-Access-Poop"; // *** edit AP name here
      ...
      if (client.available()) {             // if there's bytes to read from the client
        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            client.println("<style>html { font-family: Bradley Hand; display: inline-block; margin: 0px auto; text-align: center;}");
            client.println(".button { background-color: #950DD1; border: #07E336; color: white; padding: 16px 40px;");
            client.println("text-decoration: none; font-size: 120px; margin: 2px; cursor: pointer;}");
            client.println(".button2 {background-color: #07E336;}</style></head>");
            
            // ====== Webpage Title ======
            // *** edit text here
            client.println("<body><h1>salutations !</h1>");
